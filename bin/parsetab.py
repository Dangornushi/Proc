...
_lr_productions = [
  ...
  ('expr -> NAME NAME EQUAL NAME','expr',4,'p_mov','main.py',76),
  ('expr -> NAME NAME EQUAL NAME PLUS NAME','expr',6,'p_addandmov','main.py',87),
  ('expr -> NAME NAME EQUAL NAME MINUS NAME','expr',6,'p_subandmov','main.py',96),
  ('expr -> NAME NAME EQUAL NAME DIVIDE NAME','expr',6,'p_divandmov','main.py',104),
  ('expr -> NAME NAME EQUAL NAME TIMES NAME','expr',6,'p_timandmov','main.py',110),
  ('expr -> NAME NAME MINUS SENT','expr',4,'p_sub','main.py',116),
  ('expr -> NAME NAME','expr',2,'p_msg','main.py',123),
  ('SENT -> expr','SENT',1,'p_SENT','main.py',131),
  ('expr -> NAME NAME LKAKKO NAME RKAKKO LNAMI','expr',6,'p_define','main.py',136),
  ('expr -> NAME NAME IF1 NAME LNAMI','expr',5,'p_if','main.py',150),
  ('expr -> NAME NAME IF2 NAME LNAMI','expr',5,'p_if2','main.py',157),
  ('expr -> NAME NAME EQUAL EQUAL NAME LNAMI','expr',6,'p_if3','main.py',164),
  ('expr -> NAME NAME LNAMI','expr',3,'p_while','main.py',171),
  ('expr -> NAME LKAKKO NAME RKAKKO','expr',4,'p_call','main.py',178),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','main.py',183),
]
